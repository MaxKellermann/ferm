...
#
# Copyright (C) 2001-2008 Max Kellermann, Auke Kok
#
...
With a trailing pipe symbol, B<ferm> executes a program and parses its
output:
...
Copyright (C) 2001-2008 Max Kellermann <max@foo-projects.org>, Auke
