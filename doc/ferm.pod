...
=item B<realgoto [custom-chain-name]>
...
The keyword B<realgoto> was chosen during the transition period,
because B<goto> (already deprecated) used to be an alias for B<jump>.
