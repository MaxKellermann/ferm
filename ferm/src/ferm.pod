...
Normally you would type this for iptables(8):
...
list: "(ESTABLISHED RELATED)" or a single value.
...
specified as a normal ferm-list: "(SYN ACK RST)" or a single value.
...
Copyright (C) 2001-2003, Auke Kok <sofar@foo-projects.org>
